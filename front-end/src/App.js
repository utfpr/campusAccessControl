...
import ListaAcessos from "./screens/listaAcessos";
import AcessosporUsuarios from "./screens/accessosPorUsuario";
    ...
    return (
      <Router>
        <div>
          ...
          <Route path="/acessos" exact component={ListaAcessos} />
          <Route path="/meusAcessos" exact component={AcessosporUsuarios} />
        </div>
      </Router>
    );
  }
